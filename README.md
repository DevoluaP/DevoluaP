...
##### PT
Tenho experiência em front-end utilizando HTML, CSS, JavaScript, React.js, Angular, TypeScript e React Native. No back-end, trabalho com Node.js, PHP, Python, Java e APIs RESTful, integrando sistemas e gerenciando bancos de dados SQL (MySQL e PostgreSQL) e NoSQL (MongoDB). Também possuo experiência com infraestrutura em nuvem, realizando deploys automatizados e gerenciamento de ambientes utilizando AWS, Microsoft Azure e Docker. Para testar as aplicações, utilizo diversas ferramentas como Postman, Jest, Cypress, Playwright, JUnit, PHPUnit, entre outras, conforme a linguagem de programação utilizada.

##### EN
I have experience in front-end using HTML, CSS, JavaScript, React.js, Angular, TypeScript and React Native. On the back-end, I work with Node.js, PHP, Python, Java and RESTful APIs, integrating systems and managing SQL databases (MySQL and PostgreSQL) and NoSQL databases (MongoDB). I also have experience with cloud infrastructure, performing automated deployments and managing environments using AWS, Microsoft Azure, and Docker. To test the applications, I use various tools such as Postman, Jest, Cypress, Playwright, JUnit, PHPUnit, among others, depending on the programming language used.
