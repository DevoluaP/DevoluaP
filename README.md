...
##### EN
I have experience in front-end development using HTML, CSS, JavaScript, React.js, Angular, TypeScript, and React Native. On the back-end, I work with Node.js, PHP, Python, Java, and RESTful APIs, integrating systems and managing SQL (MySQL and PostgreSQL) and NoSQL (MongoDB) databases. I also have experience with cloud infrastructure, performing automated deployments and managing environments using AWS, Microsoft Azure, and Docker. To test applications, I use various tools such as Postman, Jest, Cypress, Playwright, JUnit, and PHPUnit, among others, depending on the programming language used.
